...
The children will be the components that need access to the context values provided by InstagramContextProvider.

# Feedback

2/3 points

Yes but to provide the context globally, which component should you use?
